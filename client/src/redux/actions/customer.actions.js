...
export const deleteCustomerStart = createAction(actions.DELETE_CUSTOMER_START)
export const deleteCustomerSuccess= createAction(actions.DELETE_CUSTOMER_SUCCESS)
export const deleteCustomerError = createAction(actions.DELETE_CUSTOMER_ERROR)