						...
						<div className="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb">
								<ol className="breadcrumb">
									...
									<li className="breadcrumb-item active" aria-current="page">Datatable Table</li>
								</ol>
							</nav>
						</div>
				...
				<div className="row clearfix">
						...
						<div className="card">
							...
							<div className="body">
								<div className="table-responsive">
									{/* <table className="table table-hover js-basic-example dataTable table-custom spacing5">
										<thead>
											<tr>
												<th>Name</th>
												<th>Position</th>
					...
					<div className="col-lg-12">
						<div className="card">
							...
							<div className="body">
								<button className="btn btn-primary btn-round mr-1">Copy</button>
								<button className="btn btn-primary btn-round mr-1">CSV</button>
								<button className="btn btn-primary btn-round">Print</button>
								<div className="table-responsive">
									<MDBDataTable
...
export default TableJqueryDatatable
