...
const AddCustomer = (props) => {
  ...
  useEffect(() => {
    if (props.isEditing) {
      const {
        user: { firstName, address, lastName, age, email, phoneNo },
      } = customer.customersData.find((cust) => cust._id === params.id);
      setValues({
        firstName,
        lastName,
        age,
                  ...
                  {props.isEditing ? (
                    <div>
                      <button
                        onClick={() =>
                          dispatch(
                            updateCustomerStart({ ...values, _id: params.id })
                          )
                        }
                        type="button"
          ...
          <div className="modal-content">
            ...
            <div className="modal-footer">
              ...
              <button
                ...
                onClick={() =>
                  dispatch(deleteCustomerStart({ _id: params.id }))
                }
              >
                Delete
              </button>
